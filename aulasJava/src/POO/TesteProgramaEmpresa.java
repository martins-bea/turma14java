...
public class TesteProgramaEmpresa {
		...
		//programa principal
			...
			System.out.println("Digite o número de tel: ");
			...
			System.out.println("Digite a crédito desse fornecedor: ");
			credito = leia.nextDouble();
			
			System.out.println("Digite a dívida desse fornecedor: ");
			...
			System.out.println("Salário base de R$ 1000.00 e valor de imposto de 10%:");	
			
			System.out.println("Nome: " + empregado.getNome() + " Tel: " + empregado.getTelefone() + " Salário líquido:" + empregado.calcularSalario());
