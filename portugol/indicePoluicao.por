programa
{
	...
	funcao inicio()
	{
		...
		/poluição mantém 3 grupos de indústrias que são altamente poluentes do 
		/meio ambiente. O índice de poluição aceitável varia de 0,05 até 0,25. Se o índice sobe
		...
		leia (indice)
			...
			se (indice <= 0.05 ou indice <= 0.25){
				escreva("Nenhuma empresa deve suspender suas atividades.")
				}
			...
			senao se (indice >= 0.5){
				escreva("Empresas do grupo 1, 2 e 3 devem suspender as atividades.")
				}
